# -*- coding: utf-8 -*-
"""
Created on Wed May 22 11:09:20 2024
    ...
    # for shell and tube heat exchanger
        ...
        while True:
            ...
            if rdo<0:
                ...
                result_label5.grid(row=38, column=0, columnspan=2, pady=10)
                result_label2.grid_forget()
                result_label1.grid_forget()
                result_label4.grid_forget()
                result_label3.grid_forget()
                ...
                if delps<p_allowed and delpT<p1_allowed:
                    ...
                    desc_3 = f"dirty heat transfer coefficient is {ud2}"
                    desc_4 = f"clean heat transfer coefficient is {Uc}"
                    desc_5 = f"the heat duty is {q}"
                    desc_6 = f"pressure drop at tube side is {delpT}"
                    desc_7 = f"pressure drop at shell side is {delps}"
