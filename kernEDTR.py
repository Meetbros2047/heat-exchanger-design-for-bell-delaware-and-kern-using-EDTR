# -*- coding: utf-8 -*-
"""
Created on Mon May 27 01:15:05 2024
        ...
        while True:
            ...
            if rdg>rdc:
                ...
                if ps<p_allowed and pT<p1_allowed:
                    ...
                    desc_3 = f"dirty heat transfer coefficient is {ud} watt/(m^2)*K"
                    desc_4 = f"clean heat transfer coefficient is {Uc} watt/(m^2)*K"
                    desc_5 = f"the heat duty is {q} watt"
                    desc_6 = f"pressure drop at tube side is {pT} pascal"
                    desc_7 = f"pressure drop at shell side is {ps} pascal"
